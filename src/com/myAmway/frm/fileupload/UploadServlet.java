...
public class UploadServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 7647138404200088587L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		FileuploadProgressListener getBarListener = new FileuploadProgressListener(req);
		...
		try {
			...
			while (formItem.hasNext()) {
				...
				if (item.isFormField()) {
					...
					System.out.println("e:\\temp" + "\\" + fileName);
